...
public class CarsModels {
    ...
    public void getMarks(String brand, ArrayAdapter<String> modelsList) {
        ...
        if (brand.equals("Abarth")) {
            ...
            modelsList.add("M8");
            modelsList.add("Inny");
            modelsList.add("Seria 1");
            modelsList.add("Seria 2");
            modelsList.add("Seria 3");
            modelsList.add("Seria 4");
            modelsList.add("Seria 5");
            modelsList.add("Seria 6");
            modelsList.add("Seria 7");
            modelsList.add("Seria 8");
            modelsList.add("X1");
            modelsList.add("X2");
            modelsList.add("X3");
            modelsList.add("X4");
